...
var _queryUrl_sqlViewData_Unknown = _apiUrl + 'sqlViews/zDtkWCN7AuF/data.json?var=prgid:' + _programId + '&var=unknowndeid:' + AGG_DE_SEGMENTATION_UNKNOWN;
...
app.submitDataToAggr = function( dataJson, type )
{
	...
	if ( type === "unknown" )
	{
		...
		for ( i = 0; i < 24; i++ )
		{
			...
			jsonData.push( app.getJsonData( AGG_DE_SEGMENTATION_UNKNOWN, ouid, pe, "1") );
			jsonData.push( app.getJsonData( AGG_DE_SEGMENTATION_A, ouid, pe, "0") );
			jsonData.push( app.getJsonData( AGG_DE_SEGMENTATION_B, ouid, pe, "0") );
			jsonData.push( app.getJsonData( AGG_DE_SEGMENTATION_C, ouid, pe, "0") );
			jsonData.push( app.getJsonData( AGG_DE_SEGMENTATION_D, ouid, pe, "0") );
